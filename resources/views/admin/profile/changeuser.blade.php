                                ...
                                <form action="{{ url('admin/profile/updateprofile') }}" method="post"
                                    ...
                                    <ul class="list-group list-group-unbordered  bg-danger mb-3 w-50 mx-auto">
                                        <li class="list-group-item bg-white">
                                            <b>User Name</b> <a class="float-right"><input type="text"
                                                    class="bg-white form-control col-sm-12" id="usr" name="user_name"
                                                    value="{{ $userlist->name }}"></a>
                                        </li>
                                        <li class="list-group-item bg-white">
                                            <b>User Email</b> <a class="float-right"> <input type="email"
                                                    class="bg-white form-control" name="user_email"
                                                    value="{{ $userlist->email }}"></a>
                                        </li>
                                        ...
                                        {{--  <li class="list-group-item bg-white">
                                            <b>Old Password</b> <a class="float-right"> <input type="password"
                                                    class="bg-white form-control" name="old_password"
                                                    value="{{ old('old_password') }}"></a>
                                        </li>
                                        <li class="list-group-item bg-white">
                                            <b>New Password</b> <a class="float-right"> <input type="password"
                                                    class="bg-white form-control" name="new_password"
                                                    value="{{ old('new_password') }}"></a>
                                        </li>  --}}
                                    </ul>
