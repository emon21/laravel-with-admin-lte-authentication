            ...
            <ul class="dropdown-menu pt-4 bg-info mt-2">
                ...
                {{-- <li class="user-body ml-2">
                      <div class="row">
                        ...
                        <div class="col-xs-4 ml-4 pr-4 text-center">
                          <a href="#">Sales</a>
                        </div>
                        <div class="col-xs-4 ml-4 text-center">
                          <a href="#">Friends</a>
                        </div>
                      </div>
                      <!-- /.row -->
...
@elseif(Auth::user()->role_id == 2)
                    ...
                    <div class="float-right">
                        ...
                        <a class="btn btn-outline-danger text-white btn-flat" href="{{ route('logout') }}" onclick="event.preventDefault();
